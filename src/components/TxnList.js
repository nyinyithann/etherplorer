...
"
                    ...
                    <tbody className="w-full min-w-full border-separate border-spacing-0 divide-y divide-100 font-sans text-[0.8rem] text-800 overflow-auto">
                        {transactions.map((x) => (
                            <tr key={x.hash} className="w-full border-separate border-spacing-0 min-w-full overflow-auto">
                                ...
                                <td className="p-2 min-w-[4rem] inline-block w-[8rem]">{x.age}</td>
                                <td className="p-2 min-w-[10rem] text-right">{x.value}</td>
                                <td className="p-2 min-w-[10rem] text-right">{x.gasPrice}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                <div
                    className={`${loading && !error ? 'flex' : 'hidden'
